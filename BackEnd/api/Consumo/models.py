...
class Consumo(models.Model):
    ...
    def atualizar_valores_acumulados(self):
        ...
        self.calorias_total = self.refeicoes_list.aggregate(Sum('calorias_total'))['calorias_total__sum'] or 0
        self.carboidratos_total = self.refeicoes_list.aggregate(Sum('carboidratos_total'))['carboidratos_total__sum'] or 0
        self.porcao = self.refeicoes_list.aggregate(Sum('porcao'))['porcao__sum'] or 0
        self.gorduras_total = self.refeicoes_list.aggregate(Sum('gorduras_total'))['gorduras_total__sum'] or 0
        self.proteinas_total = self.refeicoes_list.aggregate(Sum('proteinas_total'))['proteinas_total__sum'] or 0
